...
$('#uploadToCloud').click(function () {
    ...
    $.each(items, function (key, value) {
        $.post('http://192.168.1.67:3001/products/', value).done(function (data){
            console.log('done');
        });
    });
...
$.get('http://192.168.1.67:3001/products', function(data) {
    var text= '';
...
$(".clearCloudData").click(function () {
    $.getJSON('http://192.168.1.67:3001/products/delete', function (data) {
